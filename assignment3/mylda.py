...
#LDA
k = 1
data = addLabels(data, trainLabels)
trainData = reduceDimensionLDA(data, k)
testData = addLabels(testData, testLabels)
testData = reduceDimensionLDA(testData, k)
...
#print correctValues
print accuracy
#Accuracy is less : Random probes added in data, features may not be gaussian, LDA reduces dimensions
